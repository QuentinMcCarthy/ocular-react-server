...
class Designers extends Component {
	...
	componentDidMount() {
		fetch('https://ocular-node-server.herokuapp.com/data/staff.json')
			.then(res => res.json())
			.then((staffData) => {
				this.setState({
					staff: staffData
	...
	fetchUserData(staff){
		fetch(`https://ocular-node-server.herokuapp.com/behance/user/${staff.behance}`)
			.then(res => res.json())
			.then((userData) => {
			...
			fetch(`https://ocular-node-server.herokuapp.com/behance/user/${staff.behance}/projects`)
				.then(res => res.json())
